...
def main():
    ...
    parser.add_argument('--checkpoint_path', default='runs/vocoder/checkpoints')
    ...
    if os.path.exists(a.checkpoint_path):
        shutil.rmtree(a.checkpoint_path)
    os.makedirs(a.checkpoint_path)
